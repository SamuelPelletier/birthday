...
$(document).ready(function(){
	...
	function printResult(){
      ...
      $('#halfText').append('<div class="sub-main"><button class="button-two"><a href="index_travel.html"><span style="color:white">Your gift !</span></a></button></div>');
